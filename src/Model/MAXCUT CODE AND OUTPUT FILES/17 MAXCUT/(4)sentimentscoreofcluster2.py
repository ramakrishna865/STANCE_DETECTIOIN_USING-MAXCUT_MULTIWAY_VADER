...
# Read the Excel file
df = pd.read_excel("C:\\Users\\Rama Krishna\\Desktop\\17 MAXCUT\\17thc2tweets.xlsx")

# Apply the function to calculate sentiment metrics for each text
...
df.to_excel("C:\\Users\\Rama Krishna\\Desktop\\17 MAXCUT\\17thc2tweetsts.xlsx", index=False)
